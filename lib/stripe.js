...
async function onCheckoutCompleted(event) {
  ...
  if (existing) {
    ...
    await sendEmail({
      to:      email,
      subject: 'Welcome to ClubCompanion — complete your setup',
...
async function onSubscriptionDeleted(event) {
  ...
  await sendEmail({
    to:      user.email,
    subject: 'Your ClubCompanion subscription has been cancelled',
...
function welcomeSetupEmail(email, plan) {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
    <div style="background:#1f3b2d;padding:32px;text-align:center;">
      <h1 style="color:#c89b3c;margin:0;font-size:24px;">⛳ Welcome to ClubCompanion</h1>
    </div>
    <div style="padding:32px;background:#faf7f2;">
      ...
      <div style="text-align:center;margin:32px 0;">
        <a href="https://clubcompanion.ai/signup" style="background:#1f3b2d;color:#fff;padding:14px 28px;border-radius:8px;text-decoration:none;font-weight:600;">Complete Setup →</a>
      </div>
...
function cancellationEmail(name) {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
    ...
    <div style="padding:32px;background:#faf7f2;">
      <p>Hi ${name},</p>
      <p style="color:#555;">Your ClubCompanion subscription has been cancelled. Your agent will stop running at the end of your current billing period.</p>
      <p>If you cancelled by mistake or want to re-subscribe, you can do so any time at <a href="https://clubcompanion.ai/#pricing" style="color:#1f3b2d;">clubcompanion.ai</a>.</p>
...
function paymentFailedEmail(name) {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
    ...
    <div style="padding:32px;background:#faf7f2;">
      <p>Hi ${name},</p>
      <p style="color:#555;">We were unable to process your ClubCompanion payment. Your agent is still active for now, but will be paused if payment is not received within 5 days.</p>
